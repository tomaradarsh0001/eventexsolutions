                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <label class="radio-label">
                                        <input type="radio" name="side" value="left" {{ old('side', 'left') == 'left' ? 'checked' : '' }}>
                                    ...
                                    <!-- Right Side Radio -->
                                    <label class="radio-label">
                                        <input type="radio" name="side" value="right" {{ old('side') == 'right' ? 'checked' : '' }}>
                            ...
                            <div>
                                <label class="flex items-center gap-2 cursor-pointer">
                                    <input type="checkbox" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} class="w-4 h-4 text-purple-600 rounded focus:ring-purple-500">

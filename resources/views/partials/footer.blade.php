                ...
                <ul class="image-list">
                    <li>
                        ...
                        <div class="post-content">
                            <h6 class="post-title"> <a href="{{ url('blog/1') }}">Lorem ipsm dolor sumit.</a> </h6>
                    ...
                    <li>
                        ...
                        <div class="post-content">
                            <h6 class="post-title"><a href="{{ url('blog/2') }}">Lorem ipsm dolor sumit.</a></h6>
                            <div class="meta"><span class="date">October 12, 2018</span></div>
                        </div>
                    </li>
                </ul>
            ...
            <div class="col-md-6 col-lg-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-delay="0.8s">
                ...
                <div class="widget">
                    <div class="newsletter-wrapper">
                        <form method="POST" action="{{ route('dashboard') }}" id="subscribe-form" name="subscribe-form" class="validate">
                            @csrf
